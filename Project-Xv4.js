// ==UserScript==
// @name        Project X V4 :D
// @namespace    BY Golden Mace :D
// @version      4 last version
// @description  By Golden Mace :D
// @author       Golden Mace :D(edited by Nuro)
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/*
...
var YouName = window.prompt("You Name (Golden Mace IF NOT WHY R U ON THIS HACK >:( HUH):","");
...
(() => {
	try {
		...
		const modules = new Collection([{
			id: "core",
			name: "Core",
			description: "SUP_GOLDEN_MACES LAST V4 :) HOPE YOULL LIKE AND SUB TO ME FOR MORE HACKS LIKE THIS ONE :P",
			required: true,
			init: () => {
...
newImg.src = "https://i.imgur.com/RzHb7oT.gif";
newImg.style = `position: absolute; top: 135px; left: 86%; z-index: 100000; width: 100px; height: 100px; cursor: pointer;`;
...
function animate(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'THEMOSTOPHackHaHa';
   } else {
       characters = 'KILL';
   }
   if(space) {
...
function crash(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'MOST_OPHACK_EVERMADE';
   } else {
       characters = 'Crash?';
   }
   if(space) {
...
function lol(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'CommonITHOUGHTUWEREGOOD_';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
function mess(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'EZ_WIN_EZ_LEAVE_THE_GAME';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
function mes(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'GET_REKT_IM)LEVEL_ONE';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <h3 style="font-size: 17px;">YAY Golden Mace :D!</h3>
            <p>Greasy Fork</p>
        </div>
    </div>
</div>
...
setTimeout( () => {
setTimeout( () => {
$('#gameName').append('P̸̟̉')
setTimeout( () => {
$('#gameName').append('h̴͒ͅ')
setTimeout( () => {
$('#gameName').append('á̷̼')
setTimeout( () => {
$('#gameName').append('n̷͐͜')
setTimeout( () => {
$('#gameName').append('ṭ̴̑')
setTimeout( () => {
$('#gameName').append('o̴̢͐')
setTimeout( () => {
$('#gameName').append('m̴̳̀')
setTimeout( () => {
$('#gameName').append('_')
setTimeout( () => {
$('#gameName').append('H')
...
setInterval(() => {
setTimeout( () => {
document.getElementById('chatBox').placeholder = "HACK_CHAT";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "HA_K_C_AT";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "_ACK__H_T";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "_A_K_C_A_";
}, 100);
}, 100);
}, 100);
}, 100);}
...
document.getElementById('loadingText').innerHTML = 'P̸̟̉h̴͒ͅá̷̼n̷͐͜ṭ̴̑o̴̢͐m̴̳̀ ̷͍͘X̵͕͘ ̷͎̚M̷̯͑e̶͍̽n̸̝̚ǘ̷͇';
setTimeout( () => {
document.getElementById('loadingText').innerHTML = 'OP_HACK_OP';
}, 400);
   500;

setInterval(() => {
document.getElementById('enterGame').innerHTML = 'P̸̟̉h̴͒ͅá̷̼n̷͐͜ṭ̴̑o̴̢͐m̴̳̀ ̷͍͘X̵͕͘ ̷͎̚M̷̯͑e̶͍̽n̸̝̚ǘ̷͇';
setTimeout( () => {
document.getElementById('enterGame').innerHTML = 'READY_UP';
}, 400);}
 , 500);
...
setInterval(() => {
setTimeout( () => {
document.getElementById('nameInput').placeholder = "Slaxy";
setTimeout( () => {
document.getElementById('nameInput').placeholder = "꧁༒☬ᤂℌ໔ℜ؏ৡ☬༒꧂";
}, 200);
}, 200);}
 , 500);
setInterval(() => {
setTimeout( () => {
document.getElementById('diedText').innerHTML = "GG_U_HAD_FUN";
setTimeout( () => {
document.getElementById('diedText').innerHTML = "GG_HOPE_U_HAD_FUN";
}, 200);
}, 200);}
 , 500);
...
document.getElementById("mainMenu").style.backgroundImage = "url(https://files.123freevectors.com/wp-content/original/127965-cool-red-random-lines-background.jpg)";
...
document.getElementById("storeButton").style.color = "black";
    $("#mapDisplay").css({background: `url('https://colourlex.com/wp-content/uploads/2017/03/Chrome-red-painted-swatch-203-225-opt.jpg')`});
$("#mapDisplay").css({
...
$('#leaderboard').append('Proect x V4');
